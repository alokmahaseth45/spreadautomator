...
#------------------------ Start Log Files ---------------------------------#
start_date  = time.strftime("%x %H:%M:%S")
status = 'Start '+Internal_process+' Collecting New Files'
...
#------------------------ Start Log Files ---------------------------------#
end_date  = time.strftime("%x %H:%M:%S")
status = 'End '+Internal_process+' to create Gridline Pdf and Png'
...
#------------------------ Start Log Files ---------------------------------#
start_date  = time.strftime("%x %H:%M:%S")
status = 'Start '+Internal_process+' copy single pdf in server folder for omni coversion'
...
status = 'End '+Internal_process+' copy single pdf in server folder for omni coversion'
...
status = 'Start '+Internal_process+' omni conversion and move files'
...
status = 'End '+Internal_process+' omni conversion and move files'
...
status = 'Start '+Internal_process+'  To Insert single excel data in sql'

with open(log_request ,'a') as log:
	log.write('Start To Insert single excel data in sql-->'+start_date+'\n')
...
#------------------------ Start Log Files ---------------------------------#
end_date  = time.strftime("%x %H:%M:%S")
status = 'End '+Internal_process+'  To Insert single excel data in sql'

with open(log_request ,'a') as log:
	log.write('End To Insert single excel data in sql-->'+end_date+'\n')
