	...
	for listpath_new in New_Request_List:
		...
		if os.path.isfile(listpath_new):
			...
			try:
				...
				#------------------------ Start Log Files ---------------------------------#
				status = 'Start External optimize pdf'
				Process_Head = 'Collect New Req'
				Process_Name = 'Collect New Req'
				Process_Time = '0'
				Current_Status = status
				...
				while not os.path.isfile(pdf_path1):
				...
				status = 'End External optimize Pdf'
				Process_Head = 'Collect New Req'
				Process_Name = 'Collect New Req'
				Process_Time = '0'
				Current_Status = status
				...
				#------------------------ Start Log Files ---------------------------------#
				start_date = datetime.now()
				status = 'Start External Break Pdf'
				Process_Head = 'Collect New Req'
				Process_Name = 'Collect New Req'
				Process_Time = '0'
				Current_Status = status
